...
1. Export the PowerPoint to PDF at `/tmp/SanEmilio_Presentation_ForestGeo3.pdf`.
2. Install `pypdfium2` and Pillow for the configured Python environment.
3. Run:

```bash
python3 scripts/export_presentation.py \
	--pptx assets/presentation/SanEmilio_Presentation_ForestGeo3.pptx \
	--pdf /tmp/SanEmilio_Presentation_ForestGeo3.pdf \
